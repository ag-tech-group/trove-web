...
export const createItemItemsPostResponseOriginOneMax = 200;

export const createItemItemsPostResponseDateEraOneMax = 100;
...
export const CreateItemItemsPostResponse = zod.object({
  ...
  "date_era": zod.union([zod.string().max(createItemItemsPostResponseDateEraOneMax),zod.null()]).optional(),
...
export const DeleteItemItemsItemIdDeleteResponse = zod.void()
