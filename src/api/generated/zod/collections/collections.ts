...
export const listCollectionsCollectionsGetResponseTotalValueOneRegExp = new RegExp('^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$');
...
export const ListCollectionsCollectionsGetResponseItem = zod.object({
  ...
  "item_count": zod.int().default(listCollectionsCollectionsGetResponseItemCountDefault),
...
export const createCollectionCollectionsPostResponseNameMax = 200;

export const createCollectionCollectionsPostResponseDescriptionOneMax = 2000;

export const createCollectionCollectionsPostResponseTypeDefault = `general`;
export const createCollectionCollectionsPostResponseTypeMax = 50;



export const CreateCollectionCollectionsPostResponse = zod.object({
  "name": zod.string().max(createCollectionCollectionsPostResponseNameMax),
  "description": zod.union([zod.string().max(createCollectionCollectionsPostResponseDescriptionOneMax),zod.null()]).optional(),
  "type": zod.string().max(createCollectionCollectionsPostResponseTypeMax).default(createCollectionCollectionsPostResponseTypeDefault),
  "id": zod.uuid(),
  "user_id": zod.uuid(),
  "created_at": zod.iso.datetime({"offset":true}),
  "updated_at": zod.iso.datetime({"offset":true})
...
export const getCollectionCollectionsCollectionIdGetResponseTotalValueOneRegExp = new RegExp('^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$');
...
export const GetCollectionCollectionsCollectionIdGetResponse = zod.object({
  ...
  "created_at": zod.iso.datetime({"offset":true}),
  "updated_at": zod.iso.datetime({"offset":true}),
  "item_count": zod.int().default(getCollectionCollectionsCollectionIdGetResponseItemCountDefault),
...
export const DeleteCollectionCollectionsCollectionIdDeleteResponse = zod.void()
