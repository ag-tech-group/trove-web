        ...
        <div className="prose prose-neutral dark:prose-invert space-y-6 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              we collect your email address and a password. If you sign in with
          ...
          <section>
            ...
            <p>
              ...
              basic profile information (name and email address) through
              Google's OAuth 2.0 service. This is used solely to create and
              authenticate your Trove account. We do not access your Google
              contacts, calendar, files, or any other Google services.
            </p>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-6">
              <li>
                <strong>Google OAuth:</strong> For optional sign-in
                authentication
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              notify users of significant changes by posting a notice within the
              application.
            </p>
          </section>
